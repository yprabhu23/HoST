...
from legged_gym.envs.t1.t1_config_ground import T1Cfg as T1CfgGround
from legged_gym.envs.t1.t1_config_ground import T1CfgPPO as T1CfgPPoGround
...
task_registry.register("t1_ground", LeggedRobotGround, T1CfgGround(), T1CfgPPoGround())
