...
class H12Cfg( LeggedRobotCfg ):
    ...
    class env(LeggedRobotCfg.env):
        num_one_step_observations= 88 #+ 3 * 2#+ 3 * 11  # +3*11 actions / -3 commands  i
        num_actions =  27#+ 2# + 11
        num_dofs = 27
        num_actor_history = 6
    ...
    class asset( LeggedRobotCfg.asset ):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/h1_2/h1_2.urdf'
        name = "h12"
        ...
        left_arm_joints = ['left_shoulder_pitch_joint', 'left_shoulder_roll_joint', 'left_shoulder_yaw_joint', 'left_elbow_pitch_joint', 'left_elbow_roll_joint']
        right_arm_joints = ['right_shoulder_pitch_joint', 'right_shoulder_roll_joint', 'right_shoulder_yaw_joint', 'right_elbow_pitch_joint', 'right_elbow_roll_joint']
        ...
        left_upper_body_names = ['left_shoulder_pitch', 'left_elbow_pitch']
        right_upper_body_names = ['right_shoulder_pitch', 'right_elbow_pitch']
